    ...
    const sellerItems = [
        {
            ...
            items: [
                ...
                },
                {
                    label: 'Plantillas',
                    icon: 'pi pi-copy',
                    command: () => navigate('/sellers/ContractsList',{state:{user}})
                }
            ]
        }
    ];
            ...
            items: [
                {
                    ...
                    command: () => navigate('/administrator/contracts',{state:{user}})
                },
                {
                    label: 'Vendedores',
                    icon: 'pi pi-users',
                    command: () => navigate('/administrator/SellersList',{state:{user}})
                },
                {
                    label: 'Reportes',
